...
const routes: RouteRecordRaw[] = [
  {
    ...
    meta: { title: '首页', showTabBar: true, navigationGroup: 'main', isNavigationRoot: true },
  },
  {
    path: '/orders',
    name: 'orders',
  ...
  },
  {
    ...
    meta: { title: '开团', showTabBar: true, navigationGroup: 'main', isNavigationRoot: true },
  },
  {
    path: '/messages',
    name: 'messages',
  ...
  },
  {
    ...
    meta: { title: '登录', backFallback: '/profile' },
  },
  {
    path: '/register',
    name: 'register',
    component: () => import('@/views/LoginView.vue'),
    meta: { title: '注册', backFallback: '/profile' },
  },
  {
    path: '/group-buys/:id',
    name: 'groupBuyDetail',
    component: () => import('@/views/GroupBuyDetailView.vue'),
    meta: { title: '团购详情', backFallback: '/', navigationGroup: 'publicGroupBuy' },
  },
  {
    path: '/share/group-buys/:shareToken',
    name: 'groupBuyShareDetail',
    component: () => import('@/views/GroupBuyDetailView.vue'),
    meta: { title: '团购分享', backFallback: '/', navigationGroup: 'publicGroupBuy' },
  },
  {
    path: '/leaders/:id',
    name: 'leaderDetail',
    component: () => import('@/views/LeaderDetailView.vue'),
    meta: { title: '团长主页', backFallback: '/', navigationGroup: 'leaderPublic' },
  },
  {
    path: '/checkout',
    name: 'checkout',
