...
class StoreControllerTest extends MockMvcTestBase {
    ...
    void createStore_shouldSucceed() throws Exception {
        ...
        mockMvc.perform(post(STORES_URL)
                ...
                .andExpect(jsonPath("$.data.leader.id").isNumber())
                ...
                .andExpect(jsonPath("$.data.store.id").isNumber())
                .andExpect(jsonPath("$.data.store.leaderId").isNumber())
    ...
    void createStore_afterCreate_shouldUpdateMeEndpoint() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/me")
                ...
                .andExpect(jsonPath("$.data.user.leaderId").isNumber())
                .andExpect(jsonPath("$.data.user.storeId").isNumber())
